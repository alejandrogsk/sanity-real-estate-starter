...
const PropertyCard = ({property}: {property:Property}) => {
    return(
      <div className='bg-white relative rounded-[1.5rem] w-full flex flex-col'>
    ...
    <Image alt="Some alt" width={500} height={500} className='rounded-t-[1.5rem] w-full h-auto max-h-[328px]' src={builder.image(property?.featuredImage).url()}/>
    }
  
    <h3 className='px-4 font-medium  my-3 text-base lg:text-[1.2rem]'>{property.title}</h3>
    <div className='mt-auto grid grid-cols-3  px-4 font-medium  rounded-b-[1.5rem] border-t-[1px] border-gray-200 font-sm'>
